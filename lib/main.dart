              ...
              children: <Widget>[
                ...
                TypeAheadFormField(
                  ...
                  suggestionsCallback: (pattern) {
                    return CitiesService.getSuggestionsobj(pattern);
                  },
...
class CitiesService {
  ...
  static final List<City> cityObj = [
    City(id: 1, name: 'Beirut'),
    City(id: 1, name: 'Damascus'),
    City(id: 1, name: 'San Fransisco'),
    City(id: 1, name: 'Rome'),
    City(id: 1, name: 'Los Angeles'),
    City(id: 1, name: 'Madrid'),
    City(id: 1, name: 'Bali'),
    City(id: 1, name: 'Paris'),
    City(id: 1, name: 'Bucharest'),
  ...
  static List<City> getSuggestionsobj(String query) {
    List<City> matches = <City>[];
    matches.addAll(cityObj);
